        ...
        <Card className="w-full">
          ...
          <CardContent className="p-0">
              ...
              {filteredDocuments.map((doc) => (
                ...
                >
                  <div className="flex items-start justify-between gap-2 mb-2 min-w-0">
                    <div className="flex items-start gap-2 flex-1 min-w-0 pr-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground truncate mt-1">{doc.recipient}</p>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2 mb-2 text-xs text-muted-foreground">
                    ...
                    <span className="whitespace-nowrap">กำหนดส่ง: {formatDate(doc.dueDate)}</span>
                  </div>
            ...
            <div className="px-4 pb-4 pt-4 border-t">
              <div className="flex justify-between items-center">
                <div className="space-y-1">
                  <p className="text-xs font-medium">เอกสารที่รอดำเนินการ</p>
